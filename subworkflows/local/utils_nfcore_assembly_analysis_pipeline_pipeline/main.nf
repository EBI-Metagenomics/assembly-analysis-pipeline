...
def toolCitationText() {
    def citation_text = [
        ...
        "while biosynthetic gene cluster identification using antiSMASH (Blin et al. 2021)",
        ...
        "Metabolic pathway summarization with DRAM (Shaffer et al. 2020)",
        "and Genome Properties (Richardson et al. 2018),",
        "with visualization of the taxonomica annotations with with Krona (Ondov et al. 2011) ",
